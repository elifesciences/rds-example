(function (global, factory) {
	...
	(factory((global.stencilaMini = global.stencilaMini || {}),global.substance));
...
class ExprNode {
  ...
  constructor(id, start, end) {
    ...
    this.start = start;
    this.end = end;
    if (!substance.isNumber(start) || !substance.isNumber(end)) {
...
class Definition extends ExprNode {
...
class ObjectNode extends ExprNode {
...
class EmptyArgument extends ExprNode {
...
class ExternalFunction extends ExprNode {
...
class NamedArgument extends ExprNode {
...
class Expression extends substance.EventEmitter {
...
//# sourceMappingURL=./stencila-mini.js.map